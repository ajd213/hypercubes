...
def transition_path_lengths():
    """ Plot the distributions of path lengths from one site in the largest cluster
    to all other sites. Specifically, use values of a close to 1, where p = a/N. This gives
    distributions of path lengths around the percolation transition. """
    ...
    # Number of realisations to use for each value of N_coeff
...
def plot_path_lengths():
    """ Plot the distributions of path lengths from one site in the largest cluster
    to all other sites. Use a wide range of a, where p = a/N, to show distributions both
    far away and close to the transition.  """
    ...
    # Axis labels, legend and adjustments
